...
module.exports.run = async (bot, message) => {
    //similair to dynos ?whois, tell you when they joined the server/registered account, and all the roles that they have, probably adding more soon
    try {
        ...
        var date = message.member.joinedAt.toString().substring(0, 25);
        ...
        var date2 = message.author.createdAt.toString().substring(0, 25);
